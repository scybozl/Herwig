program test
   use p2_ubaru_nmubarepbbarbnemum_config, only: ki, logfile, nlo_prefactors
   use p2_ubaru_nmubarepbbarbnemum_kinematics, only: dotproduct, boost_to_cms
   use p2_ubaru_nmubarepbbarbnemum_model, only: parse
   use p2_ubaru_nmubarepbbarbnemum_matrix, only: samplitude, &
     & initgolem, exitgolem, ir_subtraction
   use p2_ubaru_nmubarepbbarbnemum_color, only: numcs, CA
   use p2_ubaru_nmubarepbbarbnemum_rambo, only: ramb
...
subroutine  print_parameters(scale2)
   use p2_ubaru_nmubarepbbarbnemum_config, only: renormalisation, &
        convert_to_cdr, reduction_interoperation, &
        reduction_interoperation_rescue, PSP_check, PSP_rescue
   use p2_ubaru_nmubarepbbarbnemum_model
   implicit none
   real(ki) :: scale2
